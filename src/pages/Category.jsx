    ...
    <>
      <div>
        <div class="flex flex-col items-center justify-center text-sm max-md:px-4">
          ...
          <p class="text-2xl md:text-3xl font-bold text-gray-800">Category Not Found</p>
          ...
          <div class="flex items-center gap-4 mt-6">
            <NavLink to={'/'} >
              <p class="bg-gray-800 px-7 py-2.5 text-white rounded-md active:scale-95 transition-all">
                Return Home
              </p>
            </NavLink>
