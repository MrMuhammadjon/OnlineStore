import { BoxIcon, CatIcon, Heart, LanguagesIcon, Search, ShoppingBag, User } from 'lucide-react';
      ...
      <div className="w-full py-5 bg-whitek flex items-center flex-col justify-center md:top-0 md:sticky z-50 bg-white">
        <div className="w-[85%] flex items-center justify-between gap-4" id='Head-Top'>
          ...
          <div className="flex flex-2 items-center gap-4">
            <NavLink
              to="/category"
              className="text-sm text-purple-900 cursor-pointer py-2 px-3 hover:text-white flex items-center gap-1 bg-purple-300 rounded-md transition duration-300 hover:bg-purple-500"
            >
              <BoxIcon />
              {t('header.Categories')}
            </NavLink>
            <div className="flex-1">
              <form action=""
                className='flex flex-1 items-center gap-2 bg-white rounded-md border border-gray-300'>
                <input type="search"
                  placeholder={t('header.Search')}
                  className='w-full outline-none text-sm text-gray-700 p-2 px-4'
                />
                <Search className='text-gray-600 p-1 h-full rounded-sm w-10' />
              </form>
            </div>
          </div>
