...
const Banner = () => {
    ...
    return (
        <>
            ...
            <div class="mt-20 max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
                <div class="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">
                    <div class="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                        ...
                        <span class="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent font-medium">Trusted by Experts</span>
                    </div>
                    <h2 class="text-2xl md:text-4xl font-medium mt-2">
                        Unlock Your Potential with 
                            <span class="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">Expert Guidance</span>
                            & Proven Results!
                    </h2>
